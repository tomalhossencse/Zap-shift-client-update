      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block ">
            ...
            <p>Welcome back, Tomal! here's what's happing today.</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          {/* Quck Actions */}
          <button className="hidden lg:flex items-center space-x-2 py-2 px-4 bg-linear-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:shadow-lg transition-all cursor-pointer">
          ...
          {/* user profile */}
          <button className="flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-700">
            <img
